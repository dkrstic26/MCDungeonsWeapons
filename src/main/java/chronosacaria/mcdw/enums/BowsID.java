...
public enum BowsID implements IRangedWeaponID, IInnateEnchantment {
    ...
    public Map<Enchantment, Integer> getInnateEnchantments() {
        return switch (this) {
            case BOW_ANCIENT_BOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.DYNAMO), 1);
            case BOW_BONEBOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.GROWING), 1);
            case BOW_BUBBLE_BOW, BOW_SOUL_BOW, BOW_TWISTING_VINE_BOW, BOW_WEEPING_VINE_BOW, BOW_HUNTING_BOW -> null;
            case BOW_SNOW_BOW, BOW_WINTERS_TOUCH -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.FREEZING), 1);
            case BOW_BUBBLE_BURSTER, BOW_TRICKBOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.RICOCHET), 1);
            case BOW_ECHO_OF_THE_VALLEY -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.GRAVITY), 1, EnchantsRegistry.enchantments.get(EnchantmentsID.RICOCHET), 1);
            case BOW_BURST_GALE_BOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.CHARGE), 1, EnchantsRegistry.enchantments.get(EnchantmentsID.GRAVITY), 1);
            case BOW_CALL_OF_THE_VOID -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.FUSE_SHOT), 1, EnchantsRegistry.enchantments.get(EnchantmentsID.VOID_SHOT), 1);
            case BOW_ELITE_POWER_BOW -> Map.of(Enchantments.POWER, 2);
            case BOW_GREEN_MENACE -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.RICOCHET), 1, EnchantsRegistry.enchantments.get(EnchantmentsID.POISON_CLOUD), 1);
            case BOW_HAUNTED_BOW, BOW_TWIN_BOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.BONUS_SHOT), 1);
            case BOW_HUNTERS_PROMISE -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.REPLENISH), 1);
            case BOW_LOST_SOULS -> Map.of(Enchantments.MULTISHOT, 1);
            case BOW_NOCTURNAL_BOW, BOW_SHIVERING_BOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.TEMPO_THEFT), 1);
            case BOW_PHANTOM_BOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.PHANTOMS_MARK), 1, Enchantments.POWER, 1);
            case BOW_PINK_SCOUNDREL -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.RICOCHET), 1, EnchantsRegistry.enchantments.get(EnchantmentsID.WILD_RAGE), 1);
            case BOW_POWER_BOW, BOW_MASTERS_BOW -> Map.of(Enchantments.POWER, 1);
            case BOW_SABREWING -> Map.of(Enchantments.POWER, 1, EnchantsRegistry.enchantments.get(EnchantmentsID.RADIANCE), 1);
            case BOW_VOID_BOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.VOID_SHOT), 1);
            case BOW_WEB_BOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.COBWEB_SHOT), 1);
            case BOW_WIND_BOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.GRAVITY), 1);
        };
    }
