...
public enum CrossbowsID implements IRangedWeaponID, IInnateEnchantment {
    ...
    public Map<Enchantment, Integer> getInnateEnchantments() {
        return switch (this) {
            case CROSSBOW_AUTO_CROSSBOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.ACCELERATE), 1);
            ...
            case CROSSBOW_BABY_CROSSBOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.GROWING), 1);
            case CROSSBOW_BUTTERFLY_CROSSBOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.BONUS_SHOT), 1);
            case CROSSBOW_CORRUPTED_CROSSBOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.DYNAMO), 1);
            ...
            case CROSSBOW_EXPLODING_CROSSBOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.FUSE_SHOT), 1);
            case CROSSBOW_FERAL_SOUL_CROSSBOW, CROSSBOW_SOUL_CROSSBOW, CROSSBOW_SOUL_HUNTER_CROSSBOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.ENIGMA_RESONATOR), 1);
            case CROSSBOW_FIREBOLT_THROWER -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.FUSE_SHOT), 1, EnchantsRegistry.enchantments.get(EnchantmentsID.CHAIN_REACTION), 1);
            case CROSSBOW_SCATTER_CROSSBOW -> Map.of(Enchantments.MULTISHOT, 1);
            case CROSSBOW_IMPLODING_CROSSBOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.FUSE_SHOT), 1, EnchantsRegistry.enchantments.get(EnchantmentsID.GRAVITY), 1);
            case CROSSBOW_VOIDCALLER_CROSSBOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.GRAVITY), 1);
            case CROSSBOW_LIGHTNING_HARP_CROSSBOW -> Map.of(Enchantments.MULTISHOT, 1, EnchantsRegistry.enchantments.get(EnchantmentsID.RICOCHET), 1, EnchantsRegistry.enchantments.get(EnchantmentsID.THUNDERING), 1);
            ...
            case CROSSBOW_SHADOW_CROSSBOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.SHADOW_SHOT), 1);
            case CROSSBOW_SLAYER_CROSSBOW -> Map.of(Enchantments.POWER, 1, EnchantsRegistry.enchantments.get(EnchantmentsID.RICOCHET), 1);
            case CROSSBOW_VEILED_CROSSBOW -> Map.of(EnchantsRegistry.enchantments.get(EnchantmentsID.SHADOW_SHOT), 1, EnchantsRegistry.enchantments.get(EnchantmentsID.SHADOW_BARB), 1);
        };
    }
